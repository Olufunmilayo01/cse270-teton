...
class TestSmokeTest():
  ...
  def test_adminPage(self):
    ...
    self.driver.set_window_size(1426, 875)
    self.driver.find_element(By.LINK_TEXT, "Admin").click()
    elements = self.driver.find_elements(By.ID, "username")
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("Tricia")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("Tricia234")
  ...
  def test_joinPage(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Oluwatobiloba")
    self.driver.find_element(By.NAME, "lname").send_keys("Makinde")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Teeton")
    self.driver.find_element(By.NAME, "biztitle").click()
    self.driver.find_element(By.NAME, "biztitle").send_keys("Business Owner")
  ...
  def test_spotlightandJoinFeatures(self):
    self.driver.get("http://127.0.0.1:5502/teton/1.6/index.html")
    self.driver.set_window_size(1426, 875)
