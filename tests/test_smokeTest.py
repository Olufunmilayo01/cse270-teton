...
class TestSmokeTest():
  ...
  def test_spotlightsandJoinFeatures(self):
  ...
  def test_joinPage(self):
    ...
    self.driver.find_element(By.NAME, "bizname").send_keys("Tee Patterns")
  ...
  def test_directoryGridandListFeatures(self):
    self.driver.get("http://127.0.0.1:5502/teton/1.6/index.html")
    self.driver.set_window_size(1400, 861)
  ...
  def test_adminPage(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("treesar")
